  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://securepulses.com/services/red-team-operations" />
      </Helmet>

      <Header />

      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-black relative overflow-hidden pt-16">
        <video 
