  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://securepulses.com/services/compliance-consulting" />
      </Helmet>

      <Header />

      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900 relative overflow-hidden pt-16">
        <video 
